...
def split_csv_files(data_dir, train_ratio=0.6, val_ratio=0.2, test_ratio=0.2):
    ...
    print(len(val_files))
    test_files = csv_files[train_size + val_size:train_size + val_size + test_size]
...
class ApneaTrainer:
    def __init__(self, model, train_loader, val_loader, test_loader=None, num_epochs=200):  # num_epochs=200
        ...
        self.optimizer = optim.Adam(self.model.parameters(), lr=0.0005)  # lr=0.001
